                ...
                <div class="max-w-xl">
                    <form method="post" action="{{ route('task.update', $task->id) }}" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="task_name" name="task_name" type="text" value="{{ $task->task_name }}" class="mt-1 block w-full" />
                        </div>
                        ...
                        <div>
                            ...
                            <x-text-input id="task_description" name="task_description" type="text" value="{{ $task->task_description }}" class="mt-1 block w-full" />
                        </div>
